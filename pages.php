 ...
 * @since 0.2
 */
class Widgets_Reloaded_Widget_Pages extends WP_Widget {

	function Widgets_Reloaded_Widget_Pages() {
		$widget_ops = array( 'classname' => 'pages', 'description' => __('An advanced widget that gives you total control over the output of your page links.', 'widgets-reloaded') );
		$control_ops = array( 'width' => 700, 'height' => 350, 'id_base' => 'widgets-reloaded-pages' );
		$this->WP_Widget( 'widgets-reloaded-pages', __('Pages', 'widgets-reloaded'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if ( $show_home ) :
			...
			echo '"><a href="' . get_bloginfo( 'url' ) . '" title="' . get_bloginfo( 'name' ) . '">' . $link_before . __('Home', 'widgets-reloaded') . $link_after . '</a></li>';
		endif;
	...
	function form( $instance ) {
		...
		//Defaults
		$defaults = array( 'title' => __('Pages', 'widgets-reloaded'), 'hierarchical' => true, 'sort_column' => 'post_title', 'sort_order' => 'ASC', 'date_format' => get_option( 'date_format' ) );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'sort_column' ); ?>"><?php _e('Order By:','widgets-reloaded'); ?> <code>sort_column</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'sort_order' ); ?>"><?php _e('Sort Order:', 'widgets-reloaded'); ?> <code>sort_order</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'authors' ); ?>"><?php _e('Authors:', 'widgets-reloaded'); ?> <code>authors</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'meta_key' ); ?>"><?php _e('Meta Key:', 'widgets-reloaded'); ?> <code>meta_key</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'meta_value' ); ?>"><?php _e('Meta Value:', 'widgets-reloaded'); ?> <code>meta_value</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php _e('Show date?:', 'widgets-reloaded'); ?> <code>show_date</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'date_format' ); ?>"><?php _e('Date Format:', 'widgets-reloaded'); ?> <code>date_format</code></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_home' ); ?>"><?php _e('Show home?', 'widgets-reloaded'); ?> <code>show_home</code></label>
		</p>
		</div>
