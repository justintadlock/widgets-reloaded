...
if ( class_exists( 'WP_Nav_Menu_Widget' ) ) {
	 ...
	 * @since 0.8.0
	 */
	class Hybrid_Widget_Nav_Menu extends WP_Nav_Menu_Widget {
		...
		function __construct() {
			...
			/* Add custom class. */
			$this->widget_options['classname'] = 'widget-nav-menu widget_nav_menu';
...
} // End ceck for 'WP_Nav_Menu_Widget' class.
