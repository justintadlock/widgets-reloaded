...
if ( class_exists( 'WP_Widget_Calendar' ) ) {
	 ...
	 * @since 0.6.0
	 */
	class Hybrid_Widget_Calendar extends WP_Widget_Calendar {
		...
		function __construct() {
			...
			/* Add custom class. */
			$this->widget_options['classname'] = 'widget-calendar widget_calendar';
...
} // End check for 'WP_Widget_Calendar' class.