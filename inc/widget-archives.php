...
if ( class_exists( 'WP_Widget_Archives' ) ) {
	 ...
	 * @since 0.6.0
	 */
	class Hybrid_Widget_Archives extends WP_Widget_Archives {
		...
		function __construct() {
			...
			/* Add custom class. */
			$this->widget_options['classname'] = 'widget-archives widget_archive';

			/* Set custom width. */
			$this->control_options['width'] = 525;
...
} // End check for 'WP_Widget_Archives' class.
