...
if ( class_exists( 'WP_Widget_Categories' ) ) {
	 ...
	 * @since 0.6.0
	 */
	class Hybrid_Widget_Categories extends WP_Widget_Categories {
		...
		function __construct() {
			...
			/* Add custom class. */
			$this->widget_options['classname'] = 'widget-categories widget_categories';
...
} // End ceck for 'WP_Widget_Categories'.
