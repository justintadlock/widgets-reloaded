...
if ( class_exists( 'WP_Widget_Links' ) ) {
	 ...
	 * @since 0.6.0
	 */
	class Hybrid_Widget_Bookmarks extends WP_Widget_Links {
		...
		function __construct() {
			...
			/* Add custom class. */
			$this->widget_options['classname'] = 'widget-bookmarks widget_links';

			/* Set custom width. */
			$this->control_options['width'] = 800;

			/* Set custom name. */
			$this->name = __( 'Bookmarks', 'widgets-reloaded' );
...
} // End check for 'WP_Widget_Links' class.
