 ...
 * @since 0.2
 */
class Widgets_Reloaded_Widget_Categories extends WP_Widget {

	function Widgets_Reloaded_Widget_Categories() {
		$widget_ops = array( 'classname' => 'categories', 'description' => __('An advanced widget that gives you total control over the output of your category links.', 'widgets-reloaded') );
		$control_ops = array( 'width' => 700, 'height' => 350, 'id_base' => 'widgets-reloaded-categories' );
		$this->WP_Widget( 'widgets-reloaded-categories', __('Categories', 'widgets-reloaded'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		// Defaults
		$defaults = array( 'title' => __('Categories', 'widgets-reloaded'), 'style' => 'list', 'hierarchical' => true, 'hide_empty' => true, 'order' => 'ASC', 'orderby' => 'name' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'style' ); ?>"><?php _e('Style:', 'widgets-reloaded'); ?> <code>style</code></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'exclude_tree' ); ?>"><?php _e('Exclude Tree:', 'widgets-reloaded'); ?> <code>exclude_tree</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'depth' ); ?>"><?php _e('Depth:', 'widgets-reloaded'); ?> <code>depth</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'child_of' ); ?>"><?php _e('Child Of:', 'widgets-reloaded'); ?> <code>child_of</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'current_category' ); ?>"><?php _e('Current Category:', 'widgets-reloaded'); ?> <code>current_category</code></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'feed_image' ); ?>"><?php _e('Feed Image:', 'widgets-reloaded'); ?> <code>feed_image</code></label>
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['use_desc_for_title'], true ); ?> id="<?php echo $this->get_field_id( 'use_desc_for_title' ); ?>" name="<?php echo $this->get_field_name( 'use_desc_for_title' ); ?>" /> <?php _e('Use description for title?', 'widgets-reloaded'); ?> <code>use_desc_for_title</code></label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'show_last_update' ); ?>">
			<input class="checkbox" type="checkbox" <?php checked( $instance['show_last_update'], true ); ?> id="<?php echo $this->get_field_id( 'show_last_update' ); ?>" name="<?php echo $this->get_field_name( 'show_last_update' ); ?>" /> <?php _e('Show last update?', 'widgets-reloaded'); ?> <code>show_last_update</code></label>
		</p>
		<p>
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['feed'], true ); ?> id="<?php echo $this->get_field_id( 'feed' ); ?>" name="<?php echo $this->get_field_name( 'feed' ); ?>" /> <?php _e('Show RSS feed?', 'widgets-reloaded'); ?> <code>feed</code></label>
		</p>
		</div>
